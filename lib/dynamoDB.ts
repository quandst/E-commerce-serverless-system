...
export class Database extends Construct {
    ...
    private configureAutoScaling(table: Table) {
    ...
    private createGlobalSecondaryIndex(
        table: Table,
        indexName: string,
    ...
    private createProductTable() {
        const productTable = this.createTable(constants.productTable);

        this.createGlobalSecondaryIndex(
            productTable,
    ...
    private createOrderTable() {
        this.createTable(constants.orderTable, 'user', {
            name: 'intent',
