...
jest.mock('../../../../lib/utils', () => ({
  ...
  getCredentials: jest
    .fn()
    .mockImplementation(
      (_identityPoolId: string, event: APIGatewayProxyEventV2) =>
...
describe('ProductID Service', () => {
  ...
  it('should get products by id', async () => {
    ...
    mockConstants.sendSpy.mockImplementation(((_command: GetItemCommand) => {
  ...
  it('should delete/update products by id', async () => {
    ...
    mockConstants.sendSpy.mockImplementation(((_command: DeleteItemCommand) =>
